...
## The [LokAccessStrategy] is an abstract class that defines
## how data should be saved and loaded.
## 
## This class is meant to be extended by concrete strategies that
## implement the [method save] and [method load] methods. There
## are two strategies built-in to the Locker Plugin, but
## you can create your own by extending this class. [br]
## [br]
...
## The [method save] method saves the [param data] in the [param path].
## This method is meant to be overridden by concrete strategies.
func save(data: Dictionary, path: String) -> Error:
	push_error("LokAccessStrategy.save() is not implemented.")
	return ERR_UNCONFIGURED

## The [method load] method loads data from the [param path].
## This method is meant to be overridden by concrete strategies.
func load(path: String) -> Dictionary:
	push_error("LokAccessStrategy.load() is not implemented.")
	return { "status": ERR_UNCONFIGURED, "data": {} }
